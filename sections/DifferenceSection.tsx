        ...
        <div className="relative rounded-[1.75rem] border border-celeste/15 bg-[#0a2544]/80 px-8 py-14 md:px-16 md:py-20">
          ...
          <Reveal delay={0.15}>
            <p className="text-muted mx-auto mt-8 max-w-2xl text-center text-lg leading-relaxed md:text-xl">
              <em>
                Most freelance marketplaces run on blind trust. Pocket runs on
                escrow. The budget is locked the moment a project begins, and
                the specialist is paid the moment it&apos;s approved. Built on
                Stellar. Non-custodial. Always yours.
              </em>
            </p>
          </Reveal>
        </div>
