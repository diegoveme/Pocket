...
const pillars = [
  {
    icon: 'icon-verified',
    title: 'Vetted talent',
    description: "Every growth, sales and marketing pro is verified before they're in.",
  },
  {
    icon: 'icon-lock',
    title: 'Guaranteed pay',
    description: 'Funds lock in escrow and release only when the work is accepted.',
  },
  {
    icon: 'icon-shield',
            ...
            <StaggerItem key={pillar.icon}>
              <article className="group flex flex-col items-start md:max-w-xs">
                <FloatingIcon
                  ...
                  delay={index * 0.4}
                />
                <h3 className="headline-md mb-3 text-celeste-light">{pillar.title}</h3>
