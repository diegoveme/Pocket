...
const steps = [
  {
    ...
    description: 'The startup locks the budget on-chain before any work starts.',
  },
  {
    number: '2',
    icon: 'icon-work',
    title: 'Do the work',
    description: 'The specialist delivers the project, milestone by milestone.',
  },
  {
    number: '3',
    icon: 'icon-release',
    title: 'Release on approval',
    description: 'Approve the deliverable and payment is released instantly.',
  },
] as const;
            ...
            <StaggerItem key={step.icon}>
              ...
              >
                ...
                <div className="max-w-md">
                  <h3 className="headline-md mb-2 text-celeste-light">{step.title}</h3>
